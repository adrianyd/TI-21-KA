...
public class RegisterLogin extends JFrame {
    ...
    private void GenerateUI(RegisterLogin frame) {
        ...
        btnLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String data[] = {
                        "212310016@student.ibik.ac.id",
                        "212310016",
                        "Muhammad Adrian Yusna"
                };
        ...
        // public void actionPerformed(ActionEvent e) {
        // String myEmail = "212310016@student.ibik.ac.id";
        // String myName = "Muhammad Adrian Yusna";
        // String myPass = "212310016";
